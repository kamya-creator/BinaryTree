...
public class TopViewOfBT {
    public static void main(String[] args) {
        ...
        verticalOrderTopView(tree, map, min, max);
    ...
    public static void verticalOrderTopView(TreeNode node, HashMap<Integer, Integer> map, int[] min, int[] max)
    {
        if(node == null)return;
        ...
        while (queue.size() > 0)
        {
            ...
            for (int i = 0; i < size ; i++) {
                ...
                if(!map.containsKey(horizonatlDistance_))
